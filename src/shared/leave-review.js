                ...
                <MDBContainer>
                    ...
                    <MDBRow >
                        <MDBCol size="4">
                            ...
                            <MDBCol>
                            <div className="icon">
                            <MDBIcon far={!this.state.food} onClick={this.handleFood} icon="thumbs-up fa-2x" className="theme-red"/>
                            </div>
                            </MDBCol>
                            </MDBRow>
                        </MDBCol>
                        <MDBCol size="4">
                            ...
                            <MDBCol>
                            <div className="icon">
                            <MDBIcon far={!this.state.atmos} onClick={this.handleAtmos} icon="thumbs-up fa-2x" className="theme-red"/>
                            </div>
                            </MDBCol>
                            </MDBRow>
                        </MDBCol>
                        <MDBCol size="4">
                            ...
                            <MDBCol>
                            <div className="icon">
                            <MDBIcon far={!this.state.service} onClick={this.handleService} icon="thumbs-up fa-2x" className="theme-red"/>
                            </div>
                            </MDBCol>
                            </MDBRow>
                        </MDBCol>
                    ...
                    <MDBRow>
                        <MDBCol size="9" className="offset-1">
                            <MDBBtn className="btn btn-block center" color="primary">DONE</MDBBtn>
                        </MDBCol>
                    </MDBRow>
                </MDBContainer>
            </Wrapper>
